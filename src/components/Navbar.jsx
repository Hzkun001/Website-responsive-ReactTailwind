...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between">
      {/* Navbar kiri : Logo */}
      <div className="logo">
        <h1 className="text-xl sm:text-2xl md:text-3xl xl:text-3xl font-bold bg-white text-black p-1 md:bg-transparent md:text-white">My Website</h1>
      </div>
      {/* Navbar kanan : Menu */}
      <ul className={`menu flex items-center sm:gap-10 gap-4 md:static fixed left-1/2 -translate-x-1/2 md:-translate-x-0
        md:opacity-100 bg-white/10 backdrop-blur-sm p-4 rounded-br-2xl rounded-bl-2xl 
